...
def main():
    ...
    datasets = tuple(extract_from_list(args.datasets, "real-datasets", cfg))
            ...
            for m_seed in seeds:
                with open(
                    ...
                    last_train_job = split_training(
                        ...
                        job_name=f"train-{model_name}-{dataset}-{m_seed}",
                        train_fn=train,
                    ...
                    @job(
                        name=f"visualize-training-{model_name}-{dataset}-{m_seed}",
